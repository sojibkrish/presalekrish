...
const sttaddr = "0x3A830b490cd3B08964667503F0e31d9E7713eAd8";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
      fresh = "0x3A830b490cd3B08964667503F0e31d9E7713eAd8";
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': ' 0x3A830b490cd3B08964667503F0e31d9E7713eAd8',
          'symbol': 'blum',
          'decimals': '18',
          'image': 'https://cdn.prod.website-files.com/65b6a1a4a0e2af577bccce96/65ba901600bd81cc8964b9ef_blum-logo.svg',
        },
      },
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  'error'
    ...
    document.getElementById('refaddress').value = 'https://blumlive.online/?ref=' + document.getElementById('refaddress').value;
}
}
}
function copyToClipboard(id) {
  ...
  document.execCommand("Copy");
   alert("Copied success."); // send this link to invite your friends to our airdrop. receive 30% blum + 70% Token of all claims and buy
}
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0x4Cc2C32766F00720C312bc13767f9B341ca16A03";
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
  } 